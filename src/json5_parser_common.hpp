...
void _json_print_char_flag()
{
    ...
    char_flag[u' '] &= ~jsoncf_name;
    char_flag[u'\t'] &= ~jsoncf_name;
    char_flag[u'\r'] &= ~jsoncf_name;
    char_flag[u'\n'] &= ~jsoncf_name;
    ...
    char_flag[u' '] |= jsoncf_space;
    char_flag[u'\t'] |= jsoncf_space;
    char_flag[u'\r'] |= jsoncf_space;
    char_flag[u'\n'] |= jsoncf_space;

    char_flag[u'0'] |= jsoncf_digit | jsoncf_oct | jsoncf_hex | jsoncf_bin;
    char_flag[u'1'] |= jsoncf_digit | jsoncf_oct | jsoncf_hex | jsoncf_bin;
    char_flag[u'2'] |= jsoncf_digit | jsoncf_oct | jsoncf_hex;
    char_flag[u'3'] |= jsoncf_digit | jsoncf_oct | jsoncf_hex;
    char_flag[u'4'] |= jsoncf_digit | jsoncf_oct | jsoncf_hex;
    char_flag[u'5'] |= jsoncf_digit | jsoncf_oct | jsoncf_hex;
    char_flag[u'6'] |= jsoncf_digit | jsoncf_oct | jsoncf_hex;
    char_flag[u'7'] |= jsoncf_digit | jsoncf_oct | jsoncf_hex;
    char_flag[u'8'] |= jsoncf_digit | jsoncf_hex;
    char_flag[u'9'] |= jsoncf_digit | jsoncf_hex;
    char_flag[u'A'] |= jsoncf_hex;
    char_flag[u'B'] |= jsoncf_hex;
    char_flag[u'C'] |= jsoncf_hex;
    char_flag[u'D'] |= jsoncf_hex;
    char_flag[u'E'] |= jsoncf_hex;
    char_flag[u'F'] |= jsoncf_hex;
    char_flag[u'a'] |= jsoncf_hex;
    char_flag[u'b'] |= jsoncf_hex;
    char_flag[u'c'] |= jsoncf_hex;
    char_flag[u'd'] |= jsoncf_hex;
